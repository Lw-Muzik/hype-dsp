    ...
    <div className="mx-auto w-full max-w-5xl">
      ...
      >
        <div className="flex flex-col gap-4">
          ...
          {/* Advanced: search the AutoEQ database, or import a custom curve /
              DDC file (picking a bundled preset lives in the picker above). */}
          <div className="border-t border-border pt-3">
            <div className="flex flex-wrap gap-2">
              ...
              {/* Opens a file dialog rather than a disclosure panel, so unlike
                  the two above it has no open/closed state to arbitrate. */}
              <Button
                variant="ghost"
